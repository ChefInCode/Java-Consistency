...
public class dailyLogics {
    public static void main(String[] args) {
        ...
        System.out.println(lc.sameEnds(new int[]{5, 6, 45, 99, 13, 5, 6}, 2));

        //Return true if the array contains, somewhere, three increasing adjacent numbers like .... 4, 5, 6, ... or 23, 24, 25.
        // tripleUp([1, 4, 5, 6, 2]) → true
        // tripleUp([1, 2, 3]) → true
        // tripleUp([1, 2, 4]) → false
        System.out.println(lc.tripleUp(new int[]{1, 4, 5, 6, 2}));
        ...
        //zeroFront([1, 0]) → [0, 1]
        System.out.println(Arrays.toString(lc.zeroFront(new int[]{1, 0, 0, 1})));
        ...
        //evenOdd([3, 3, 2]) → [2, 3, 3]
        //evenOdd([2, 2, 2]) → [2, 2, 2]
        System.out.println(Arrays.toString(lc.evenOdd(new int[]{1, 0, 1, 0, 0, 1, 1})));
        ...
        System.out.println(Arrays.toString(lc.fizzBuzz(1, 6)));

        //Consider the leftmost and righmost appearances of some value in an array. We'll say that the "span" is the number of elements between the two inclusive. A single value has a span of 1. Returns the largest span found in the given array. (Efficiency is not a priority.)
        //maxSpan([1, 2, 1, 1, 3]) → 4
        //maxSpan([1, 4, 2, 1, 4, 1, 4]) → 6
        //maxSpan([1, 4, 2, 1, 4, 4, 4]) → 6
        System.out.println(lc.maxSpan(new int[]{1, 2, 1, 1, 3}));

        //Return an array that contains exactly the same numbers as the given array, but rearranged so that every 3 is immediately followed by a 4. Do not move the 3's, but every other number may move. The array contains the same number of 3's and 4's, every 3 has a number after it that is not a 3, and a 3 appears in the array before any 4.
        //fix34([1, 3, 1, 4]) → [1, 3, 4, 1]
        //fix34([1, 3, 1, 4, 4, 3, 1]) → [1, 3, 4, 1, 1, 3, 4]
        //fix34([3, 2, 2, 4]) → [3, 4, 2, 2]
        System.out.println(Arrays.toString(lc.fix34(new int[]{1, 3, 1, 4})));
        ...
        // seriesUp(2) → [1, 1, 2]
        System.out.println(Arrays.toString(lc.seriesUp(3)));
